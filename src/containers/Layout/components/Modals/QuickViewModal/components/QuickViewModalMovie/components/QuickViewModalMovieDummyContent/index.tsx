...
import QuickViewModalMovieDummyActions from '../QuickViewModalMovieDummyActions';

const QuickViewModalMovieDummyContent: FC = () => {
		...
		>
			<Headline
				...
				renderSubtitle={(props) => (
					<Skeleton colorMode={colorMode} isLoaded={false} variant='text'>
						<Text {...props}>Was released on ddd, MMMM DD, YYYY</Text>
					</Skeleton>
				)}
			/>

			<QuickViewModalMovieDummyActions />
...
export default QuickViewModalMovieDummyContent;
