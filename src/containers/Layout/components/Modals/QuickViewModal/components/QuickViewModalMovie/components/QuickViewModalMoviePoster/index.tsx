...
import { QuickViewModalMoviePosterProps } from './types';
...
const QuickViewModalMoviePoster: FC<QuickViewModalMoviePosterProps> = ({ movie, onClick, ...rest }) => {
...
export default QuickViewModalMoviePoster;
