...
import { QuickViewModalTVShowPosterProps } from './types';
...
const QuickViewModalTVShowPoster: FC<QuickViewModalTVShowPosterProps> = ({ show, onClick, ...rest }) => {
...
export default QuickViewModalTVShowPoster;
