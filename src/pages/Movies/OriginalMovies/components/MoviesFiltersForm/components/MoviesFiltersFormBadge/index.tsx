...
import { MoviesFiltersFormBadgeProps } from './types';

const { convertStringToNumber } = utils;

const MoviesFiltersFormBadge: FC<MoviesFiltersFormBadgeProps> = ({ color, colorMode, total = 0 }) => {
...
export default MoviesFiltersFormBadge;
