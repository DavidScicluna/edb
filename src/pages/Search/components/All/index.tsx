		...
		<VStack width='100%' spacing={4}>
			...
			<Fade
				in={
					...
					(searchTypes.length === 0 || searchTypes.some((type) => type === 'movie'))
				}
				unmountOnExit
				style={{ width: '100%' }}
			>
			...
			<Fade
				in={
					...
					(searchTypes.length === 0 || searchTypes.some((type) => type === 'tv'))
				}
				unmountOnExit
				style={{ width: '100%' }}
			>
