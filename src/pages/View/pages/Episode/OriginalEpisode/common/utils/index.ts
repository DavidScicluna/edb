...
import { TVShowEpisode, TVShowPartialSeason } from '../../../../../../../common/types/tv';

type GetAdjacentEpisodeProps = { direction: 'prev' | 'next'; seasons: TVShowPartialSeason[]; episode?: TVShowEpisode };
