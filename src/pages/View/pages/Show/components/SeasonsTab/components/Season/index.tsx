...
const Season = (props: SeasonProps): ReactElement => {
  ...
  return (
    <VStack width='100%' spacing={2}>
      <Collapse
        in={
          (!_.isNil(seasonQuery.data?.overview || overview) && !_.isEmpty(seasonQuery.data?.overview || overview)) ||
        ...
        style={{ width: '100%' }}
      >
        <Paragraph title='Overview' paragraphs={overview} isLoading={seasonQuery.isFetching || seasonQuery.isLoading} />
      </Collapse>
